...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__controllers__ = __webpack_require__(8);
/**
 * @desc server routes
 * @author Jooger <zzy1198258955@163.com>
 * @date 15 Sep 2017
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__article__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_simple_node_logger__ = __webpack_require__(143);
...
/* harmony export (immutable) */ exports["d"] = handleError;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_koa_logger__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_koa_respond__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_koa_respond___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_koa_respond__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nuxt__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nuxt___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_nuxt__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__routes__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__config__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__nuxt_config__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__nuxt_config___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__nuxt_config__);
...
global.logger = __WEBPACK_IMPORTED_MODULE_8__utils__["a" /* logger */];
...
// Set Nuxt.js options
__WEBPACK_IMPORTED_MODULE_7__nuxt_config___default.a.dev = !(app.env === 'production');

// Instantiate nuxt.js
var nuxt = new __WEBPACK_IMPORTED_MODULE_4_nuxt__["Nuxt"](__WEBPACK_IMPORTED_MODULE_7__nuxt_config___default.a);

// Build in development
if (__WEBPACK_IMPORTED_MODULE_7__nuxt_config___default.a.dev) {
...
app.use(__WEBPACK_IMPORTED_MODULE_3_koa_respond___default()({
  methods: {
    success: function success(ctx, body) {
      body = Object.assign({}, {
        code: __WEBPACK_IMPORTED_MODULE_6__config__["a" /* default */].common.code.SUCCESS
      }, body);
      ctx.send(200, body);
    },
    failed: function failed(ctx, body) {
      body = Object.assign({}, {
        code: __WEBPACK_IMPORTED_MODULE_6__config__["a" /* default */].common.code.FAILED
      }, body);
      ctx.send(200, body);
    }
  }
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__routes__["a" /* default */])(router);
    ...
    return __WEBPACK_IMPORTED_MODULE_0__Users_jooger_develop_git_jooger_me_node_modules_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            _context.next = 12;
            return __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* fetcher */].get('/repos/' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].server.github.owner + '/' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].server.github.repo + '/issues', {
              params: {
                filter: 'created',
                state: 'open',
                sort: 'created',
          ...
          case 14:
            ...
            if (!res) {
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["d" /* handleError */])({ ctx: ctx });
            }
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* fetcher */].get('/repos/' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].server.github.owner + '/' + __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].server.github.repo + '/issues/' + number, {
              ...
              return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__utils__["d" /* handleError */])({ ctx: ctx, err: err });
            });
 ...
 */
const util = __webpack_require__( 146 );
const moment = __webpack_require__( 18 );
const dash = __webpack_require__( 20 );
...
const AbstractAppender = __webpack_require__(21 );
...
const FileAppender = function(options) {
    ...
    const appender = this;
    const fs = options.fs || __webpack_require__( 13 );        
...
module.exports.AbstractAppender = __webpack_require__(21);
module.exports.Logger = __webpack_require__(19);

module.exports.appenders = {
    ConsoleAppender:__webpack_require__(137),
    FileAppender:__webpack_require__(138),
    RollingFileAppender:__webpack_require__(139)
};

module.exports.mocks = {
    MockAppender:__webpack_require__(140),
    MockLogger:__webpack_require__(145)
};
...
const dash = __webpack_require__( 20 );
const Logger = __webpack_require__(19 );
const ConsoleAppender = __webpack_require__(137 );
const FileAppender = __webpack_require__( 138 );
const RollingFileAppender = __webpack_require__( 139 );
...
const SimpleLogger = function(opts) {
    ...
    let dfltLevel = options.level || Logger.DEFAULT_LEVEL,
        ...
        fs = options.fs || __webpack_require__(13 ),
        createInterval = options.createInterval || setInterval,
